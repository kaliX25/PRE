      ...
      <main>
        <section className="home_picture-wrapper">
          ...
          <section className="circle-wrapper">
            <section
              className={`circle-1 ${imageIndex === 0 ? 'circle-yellow' : ''}`}
            ></section>
            <section
              className={`circle-2 ${imageIndex === 1 ? 'circle-yellow' : ''}`}
            ></section>
            <section
              className={`circle-3 ${imageIndex === 2 ? 'circle-yellow' : ''}`}
            ></section>
          </section>
        </section>
        <section className="home_about-wrapper">
          ...
          <section className="home_about-content">
            ...
            <p className="home_about-content-contents">
              ...
              dynamic force in the field of innovative engineering solutions,
              specializing in tackling corrosion-related challenges prevalent in
              the oil and gas, petrochemical, and allied industries.
            </p>
        ...
        <section className="home-product-wrapper">
          <section className="home-product-title">
            <h1 className="home-product-title-title">Explore Our Products</h1>
            <p className="home-product-title-content">
              Discover our high-quality products, we use the latest technology
              and implement sustainable programs in each of our productions.
            </p>
          </section>
